...
import com.example.flutter_minjing_stylish.databinding.DialogMessageBinding
 ...
 */
class PrimeDialog(context: Context, private val listener: PrimeDialogListener) : AppCompatDialog(context) {
...
//        )
    ...
    companion object {
        const val TAG = "com.example.flutter_minjing_stylish.PrimeDialog"
    }
}
